      ...
      <div className="m-auto h-fit w-fit p-5 bg-accentColor rounded-lg shadow-customShadow flex flex-row gap-10 relative scale-[0.75] md:scale-[1]">
        ...
        <div className="w-[350px] flex flex-col gap-2 justify-center">
          ...
          <div className="flex items-center justify-between ">
            <input
              id="nameInput"
              className="px-3 py-1 rounded-lg w-full bg-bgColor focus:outline-dashed shadow-[0px_3px_6px_rgba(0,0,0,0.5)] placeholder:text-gray-500 text-white"
          ...
          <button
            onClick={() => {
              ...
              if (
                nameInput.includes("0") ||
                nameInput.includes("1") ||
                nameInput.includes("2") ||
                nameInput.includes("3") ||
                nameInput.includes("4") ||
                nameInput.includes("5") ||
                nameInput.includes("6") ||
                nameInput.includes("7") ||
                nameInput.includes("8") ||
                nameInput.includes("9") ||
                nameInput.includes("9")
              ) {
